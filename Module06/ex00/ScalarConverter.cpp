...
void ScalarConverter::convert(const std::string &str)
{
	...
	// Check if input is a pseudo-literal
	...
	// Check if input is a char literal (single character in single quotes)
	char charValue = '\0';
	...
	// Check if input ends with 'f' (float literal)
	...
	// Try to convert to double first (unless it's a char literal)
	...
	// Check for overflow/underflow for int conversion
	...
	if (isCharLiteral)
	{
		// Explicit char literal provided
